...
const COLS = `id, name, mobile, pan, aadhaar, passport, address, documents,
  ...
  async create(data) {
    ...
    return tx(async (c) => {
      const r = await c.query(
        `INSERT INTO donors (id, name, mobile, pan, aadhaar, passport, address, documents)
         VALUES ($1,$2,$3,NULLIF($4,''),NULLIF($5,''),NULLIF($6,''),$7,$8::jsonb)
         RETURNING ${COLS}`,
        [
          id, data.name, data.mobile, data.pan || '', data.aadhaar || '',
